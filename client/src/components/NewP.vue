  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 bg-white" id="left_side">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group row">
              <label for="post_examino" class="col-12 col-form-label"
                >Επέλεξε εξάμηνο</label
              >
              <div class="col-12">
                <select
                  id="post_examino"
          ...
          <div class="col-md-6">
            <div class="form-group row">
              <label for="post_mathima" class="col-12 col-form-label"
                >Επέλεξε μάθημα</label
              >
              <div class="col-12">
                <select
                  id="post_mathima"
                ...
                >
                  ...
                  <option value="mhxanikh_logismikou"
                    >Μηχανική Λογισμικού</option
                  >
                  <option value="technologia_vaseon_dedomenon"
                    >Τεχνολογία Βάσεων Δεδομένων</option
                  >
                </select>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <button v-on:click="newPost" class="col-12 btn btn-primary">
              Δημοσίευση
            </button>
          </div>
        </div>
      ...
      <div class="col-md-4" id="right_side">
        <div class="row">
          <div class="card mb-3" style="max-width: 18rem;">
            <div class="card-header bg-light head">
              Δημιουργία ανάρτησης στο stackiee..
            </div>
            <div class="card-body">
              <div class="form-group row">
  ...
  methods: {
    async newPost() {
      ...
      if (empty_title === "" || empty_body === "") {
        alert(
          "Συμπλήρωσε τον τίτλο και το περιεχόμενο της ανάρτησης για να υποβληθεί η δημοσίευση"
        );
        return;
      }
      const newPost = {
